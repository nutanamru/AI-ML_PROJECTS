...
def is_open_browser(landmark_list, thumb_index_dist):
    return (
...
def detect_gesture(frame, landmark_list, processed):
    if len(landmark_list) >= 21:
        ...
        elif is_open_browser(landmark_list, thumb_index_dist):
            subprocess.Popen(["C:/Program Files/Google/Chrome/Application/chrome.exe"])  # Open Chrome browser
            cv2.putText(frame, "Browser Opened", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
